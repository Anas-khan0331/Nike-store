...
const FlexContent = ({ endpoint :{heading,title,text ,img,btn,url}}) => {
  return (
    <>
        <div className={` xl:justify-between lg:flex-col lg:justify-center nike-container grid xl:grid-cols-2 xl:text-center lg:justify-items-center  lg:grid-cols-2  md:grid-cols-1 sm:grid-cols-1`}>
            ...
            <div className='flex items-center max-w-xl relative lg:mx-w-none w-full'>
                <img src={img
                } className='w-auto my-10 object-fill transitions-theme sm:my-8 hover:rotate-[0deg] rotate-[20deg] hover:scale-100 ease-in-out transitions-all duration-700'  />
            </div>
        </div>
    </>
  )
